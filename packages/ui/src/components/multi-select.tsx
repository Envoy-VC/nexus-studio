...
import { Badge } from "@nexus-studio/ui/components/badge";
...
import {
  ...
  CommandList,
  CommandSeparator,
} from "@nexus-studio/ui/components/command";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@nexus-studio/ui/components/popover";
import { Separator } from "@nexus-studio/ui/components/separator";
    ...
    return (
      <>
        <div className="sr-only">
          {/** biome-ignore lint/a11y/useSemanticElements: safe */}
